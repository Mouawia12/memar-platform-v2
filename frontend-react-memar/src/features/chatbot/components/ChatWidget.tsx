...
// ارتفاع ثابت: الصندوق لا يتمدد مع الرسائل، بل تمرّر منطقة المحادثة داخليًا.
const panel: CSSProperties = { position: 'fixed', bottom: '90px', width: '340px', maxWidth: 'calc(100vw - 40px)', height: '520px', maxHeight: 'calc(100vh - 120px)', background: '#fff', borderRadius: '14px', boxShadow: '0 8px 40px rgba(0,0,0,.2)', zIndex: 9999, display: 'flex', flexDirection: 'column', overflow: 'hidden', border: '1px solid #E4E8EF', fontFamily: "'Cairo',sans-serif", direction: 'rtl' };
