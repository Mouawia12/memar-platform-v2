...
const TONES: Record<string, [number, number][]> = {
  ...
  // لوحة الفرص (2026-09-16): نغمة لكل حدث يعرفه الطرفان دون النظر —
  // سؤال الإدارة صاعد، الرد قفزة ناعمة، طلب التحديث ثلاث نقرات، وانتهاء المهلة رنّة مزدوجة.
  question: [[587, 0.13], [880, 0.2]],
  answer: [[784, 0.12], [1175, 0.22]],
  nudge: [[494, 0.1], [0, 0.05], [494, 0.1], [415, 0.18]],
  expired: [[1046, 0.11], [784, 0.11], [0, 0.07], [1046, 0.11], [784, 0.16]],
};
