 ...
 *
 * المحتوى يكتبه موظف ويُطبع من لوحة الإدارة **ومن بوابة العميل** — فيُنقّى الجسم
 * ويُهرَّب العنوان قبل الكتابة في النافذة الجديدة (منع XSS مخزَّن).
 */
...
<body>${sanitizeHtml(bodyHtml)}</body></html>`);
  w.document.close();
  w.focus();
