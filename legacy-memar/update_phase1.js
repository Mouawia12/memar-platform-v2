...
const startIdx = code.indexOf("  render() {\n    const pg = document.getElementById('p-dashboard');");
const endIdx = code.indexOf("    // Render charts after DOM is ready", startIdx);

if (startIdx > -1 && endIdx > -1) {
    code = code.substring(0, startIdx) + dashNew + "    // Render charts after DOM is ready" + code.substring(endIdx + 39);
} else {
